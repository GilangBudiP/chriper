    ...
    <ul>
        ...
        <li>
            <a href="javascript:;" class="top-menu">
                ...
                <div class="top-menu__title"> Menu Layout </div>
            </a>
        </li>
        <li>
            <a href="javascript:;" class="top-menu">
                <div class="top-menu__icon"> <i data-lucide="activity"></i> </div>
                <div class="top-menu__title"> Apps </div>
            </a>
        </li>
        <li>
            <a href="javascript:;" class="top-menu">
        ...
        <li>
            <a href="javascript:;" class="top-menu">
                ...
                <div class="top-menu__title"> Components </div>
            </a>
        </li>
        <li>
            <a href="javascript:;" class="top-menu">
        ...
        <li>
            <a href="javascript:;" class="top-menu">
                ...
                <div class="top-menu__title"> Widgets </div>
            </a>
        </li>
    </ul>
</nav>
